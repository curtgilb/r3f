...
export function Revuelto(props) {
  const { nodes, materials } = useGLTF("./models/lamb02/scene-transformed.glb");
  const normalsMap = useLoader(
    TextureLoader,
    "./models/lambo/textures/Material.012_normal.png"
  );
  ...
  return (
    <>
      {" "}
      <EffectComposer>
        <Bloom mipmapBlur intensity={0.5}></Bloom>
      </EffectComposer>
      <group {...props} dispose={null}>
        ...
        <mesh
          ...
          position={[1.226, 0.316, 0.82]}
          scale={0.003}
        />
        <mesh
          geometry={nodes.Wheel_BR_Tire_0.geometry}
          material={materials.Tire}
          position={[-1.342, 0.316, 0.805]}
          scale={0.003}
        />
        <mesh
        ...
        />
        {/* !BODY! */}
        <mesh geometry={nodes.Hood075_Body_0.geometry} scale={0.01}>
          <meshStandardMaterial
...
useGLTF.preload("./models/lamb02/scene-transformed.glb");
